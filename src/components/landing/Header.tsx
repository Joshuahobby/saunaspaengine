...
export function Header({ isLoggedIn }: { isLoggedIn?: boolean }) {
    ...
    return (
        <>
            ...
            >
                ...
                <div className="hidden md:flex flex-1 justify-end gap-8 items-center">
                    <nav className="flex items-center gap-9">
                        ...
                        <a className="text-[var(--text-muted)] text-xs font-black uppercase tracking-widest hover:text-[var(--color-primary)] transition-colors" href="/case-studies">Case Studies</a>
                        ...
                        <a className="text-[var(--text-muted)] text-xs font-black uppercase tracking-widest hover:text-[var(--color-primary)] transition-colors" href="/contact">Contact</a>
                    </nav>
            ...
            {/* eslint-disable-next-line react/forbid-dom-props */}
            <div
                className={`fixed inset-0 bg-app-95 backdrop-blur-2xl z-40 transition-all duration-300 md:hidden flex flex-col pt-36 px-6 gap-10 ${mobileMenuOpen ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none"
                    }`}
            >
