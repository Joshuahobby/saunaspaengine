...
export default async function Header() {
    ...
    return (
        <header className="h-16 bg-[var(--bg-app)]/80 backdrop-blur-md sticky top-0 z-50 px-6 lg:px-8 flex items-center justify-between border-b border-[var(--border-main)] shadow-sm transition-all duration-300">
            {/* Left: Title & Search */}
