            ...
            <div className="flex flex-col md:flex-row justify-between items-end gap-6 border-b border-[var(--border-muted)] pb-8">
                <div className="flex flex-col gap-2">
                    <h1 className="text-4xl lg:text-5xl font-display font-bold text-[var(--text-main)] tracking-tight">
                        Client <span className="text-[var(--color-primary)]">Directory</span>
                    </h1>
                    <p className="text-base text-[var(--text-muted)] font-medium opacity-80">Comprehensive directory of all registered clients across the platform.</p>
                </div>
                            ...
                            {clients.map((client) => (
                                <tr key={client.id} className="group/row hover:bg-[var(--bg-surface-muted)]/5 transition-colors">
                                    ...
                                    <td className="px-8 py-5">
                                        ...
                                        <p className="text-[9px] font-bold text-[var(--text-muted)] uppercase tracking-widest mt-0.5 opacity-40">{client.qrCode || 'No Resonance ID'}</p>
                                    </td>
                                    <td className="px-8 py-5">
                                ...
                                <tr>
                                    <td colSpan={6} className="px-8 py-24 text-center">
                                        <div className="flex flex-col items-center gap-4">
                                            ...
                                            <p className="text-lg font-display font-bold text-[var(--text-muted)] opacity-40">No clients found in the directory.</p>
                                        </div>
                                    </td>
                                </tr>
                            )}
