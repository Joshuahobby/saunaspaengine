            ...
            <div className="flex flex-col gap-2 border-b border-[var(--border-muted)] pb-8">
                ...
                <div className="flex justify-between items-center">
                    ...
                    <div className="flex items-center gap-3">
                        <Link 
                            href="/settings/roles"
                            className="h-10 px-6 rounded-xl border border-[var(--border-muted)] bg-[var(--bg-card)] text-[var(--text-main)] text-[10px] font-black tracking-widest uppercase flex items-center gap-2 hover:bg-[var(--bg-surface-muted)] transition-all shadow-sm"
                        >
