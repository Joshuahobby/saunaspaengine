        ...
        <div className="flex h-full w-full flex-col lg:flex-row bg-[var(--bg-app)] text-[var(--text-main)] transition-colors duration-500 overflow-hidden">
            ...
            <aside className="w-full lg:w-85 glass-card p-10 space-y-12 flex-shrink-0 hidden lg:flex flex-col border-r border-[var(--border-muted)] bg-[var(--bg-surface-muted)]/20 shadow-none">
                <div className="space-y-8">
                    <div className="px-2">
                        <h3 className="text-[10px] font-bold text-[var(--text-muted)] uppercase tracking-[0.2em] mb-8 opacity-40">Business Settings</h3>
                        <div className="flex items-center gap-5">
                            <div className="size-14 rounded-2xl flex items-center justify-center shadow-xl shadow-black/5 bg-[var(--color-primary)]/10 text-[var(--color-primary)]">
                                <span className="material-symbols-outlined text-3xl font-bold">stars</span>
                            </div>
                            <div>
                                <p className="text-base font-display font-bold leading-tight text-[var(--text-main)]">{businessData?.name || "Business"}</p>
                                <p className="text-[9px] font-bold text-[var(--text-muted)] uppercase tracking-widest mt-2 opacity-60">Verified Identity</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <nav className="flex flex-col gap-2">
                        ...
                        <Link href="/reports/revenue" className="flex items-center gap-4 px-6 py-4 text-sm font-display font-bold rounded-[1.5rem] text-[var(--text-muted)] hover:text-[var(--text-main)] hover:bg-[var(--bg-surface-muted)]/30 transition-all tracking-tight group">
                ...
                <div className="mt-auto space-y-6">
                    <div className="bg-[var(--bg-app)]/50 rounded-[2.5rem] p-8 border border-[var(--border-muted)] shadow-inner relative overflow-hidden group/health">
                        ...
                        <p className="text-[10px] font-bold text-[var(--color-primary)] mb-4 uppercase tracking-[0.2em] opacity-60">Account Status</p>
                        <div className="flex items-baseline gap-2 mb-4">
                            <span className="text-3xl font-display font-bold uppercase">{businessData?.approvalStatus}</span>
                        </div>
                        <p className="text-[9px] font-bold text-[var(--text-muted)] uppercase tracking-widest opacity-40">System verification complete</p>
                    </div>
                </div>
            </aside>
            ...
            <section className="flex-1 p-6 lg:p-12 max-w-7xl mx-auto w-full overflow-y-auto no-scrollbar scroll-smooth">
                <div className="mb-12 space-y-3">
                    <h1 className="text-5xl font-display font-bold tracking-tight text-[var(--text-main)]">Execution <span className="text-[var(--color-primary)] underline decoration-2 decoration-[var(--color-primary)]/20 underline-offset-8">Governance</span></h1>
                    <p className="text-[var(--text-muted)] mt-5 max-w-3xl text-xl font-bold leading-relaxed">Refine your business profile, regional compliance presets, and operational audit trails.</p>
                </div>

                <div className="grid grid-cols-1 xl:grid-cols-12 gap-10">
                    {/* Left Column: Map & Region Selection */}
                    <div className="xl:col-span-12 2xl:col-span-7 flex flex-col gap-10">
                        {/* New Section: Business Profile Hub */}
                        <div className="glass-card border border-[var(--border-muted)] p-12 rounded-[2.5rem] bg-[var(--bg-surface-muted)]/10 relative overflow-hidden group shadow-xl shadow-[var(--color-primary)]/5">
                            <div className="absolute -top-24 -left-24 w-96 h-96 bg-[var(--color-primary)] opacity-5 rounded-full blur-[100px] group-hover:opacity-10 transition-opacity duration-1000"></div>
                        ...
                        <div className="glass-card border border-[var(--border-muted)] overflow-hidden rounded-[2.5rem] shadow-2xl shadow-[var(--color-primary)]/5">
                            <div className="p-8 border-b border-[var(--border-muted)] flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 bg-[var(--bg-surface-muted)]/30 backdrop-blur-xl">
                                <div className="space-y-1">
                                    <h2 className="text-2xl font-display font-bold">Territorial Reach</h2>
                                    <p className="text-[10px] font-bold uppercase tracking-widest text-[var(--text-muted)] opacity-60">Compliance Focus</p>
                                </div>
                    ...
                    <div className="xl:col-span-12 2xl:col-span-5 flex flex-col gap-8">
                        <div className="glass-card border border-[var(--border-muted)] p-10 flex flex-col rounded-[2.5rem] bg-[var(--bg-card)] shadow-[0_30px_60px_-15px_rgba(0,0,0,0.1)] transition-all hover:shadow-[0_40px_80px_-20px_rgba(0,0,0,0.15)] h-fit">
                            <div className="flex flex-col gap-6 mb-12">
                                <span className="w-fit px-4 py-1.5 bg-[var(--color-primary)] text-[var(--text-main)] text-[9px] font-bold rounded-full uppercase tracking-[0.2em] shadow-lg shadow-[var(--color-primary)]/20">Presets v2.4</span>
                                ...
                                <p className="text-sm text-[var(--text-muted)] leading-relaxed font-bold">Adjust the tax rates and privacy settings for the <span className="text-[var(--text-main)] font-bold">{activeRegionName}</span> territory.</p>
                            </div>
                ...
                <div className="mt-16 mb-12 glass-card border border-[var(--border-muted)] overflow-hidden rounded-[2.5rem] bg-[var(--bg-card)] shadow-2xl shadow-black/5">
                    <div className="p-10 border-b border-[var(--border-muted)] flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 bg-[var(--bg-surface-muted)]/20">
                        <div className="space-y-1">
                            <h3 className="text-2xl font-display font-bold">Compliance <span>Activity</span></h3>
                            <p className="text-[10px] font-bold uppercase tracking-widest text-[var(--text-muted)] opacity-50">Recent compliance changes</p>
                        </div>
                        ...
                        <table className="w-full text-left border-collapse min-w-[1000px]">
                            <thead>
                                <tr className="bg-[var(--bg-surface-muted)]/10 border-b border-[var(--border-muted)]">
                                    ...
                                    <th className="py-8 px-10 text-[10px] font-bold uppercase tracking-[0.2em] text-[var(--text-muted)] opacity-40">User</th>
                                    <th className="py-8 px-10 text-[10px] font-bold uppercase tracking-[0.2em] text-[var(--text-muted)] opacity-40">Details</th>
                            ...
                            <tbody className="divide-y divide-[var(--border-muted)]">
                                {complianceLogs.length === 0 ? (
                                    <tr>
                                        <td colSpan={4} className="py-24 text-center text-[var(--text-muted)] font-serif italic text-2xl opacity-40">No compliance changes recorded yet.</td>
                                    </tr>
                                ) : (
                                        ...
                                        <tr key={log.id} className="hover:bg-[var(--bg-surface-muted)]/30 transition-colors group">
                                            ...
                                            <td className="py-8 px-10">
                                                <div className="flex items-center gap-4">
                                                    <div className="size-11 rounded-2xl bg-[var(--bg-surface-muted)] border border-[var(--border-muted)] text-[10px] flex items-center justify-center font-bold text-[var(--color-primary)] transition-all group-hover:border-[var(--color-primary)]/30">
