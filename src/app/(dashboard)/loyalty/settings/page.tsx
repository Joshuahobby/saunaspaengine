    ...
    return (
        <div className="flex flex-col lg:flex-row w-full gap-8">
            ...
            <aside className="w-full lg:w-64 flex-shrink-0 flex flex-col gap-2">
                ...
                <button className="flex items-center gap-3 px-3 py-2 rounded-lg text-slate-600 dark:text-slate-400 hover:bg-[var(--color-primary)]/10 transition-colors w-full text-left">
            ...
            <div className="flex-1 w-full max-w-6xl">
                ...
                <div className="flex flex-wrap items-center justify-between gap-4 mb-8">
                    <div>
                        <h1 className="text-4xl font-black tracking-tight text-slate-900 dark:text-slate-100">Loyalty & Rewards</h1>
                    ...
                    <div className="xl:col-span-2 space-y-8">
                        ...
                        <section className="bg-white dark:bg-slate-900 rounded-xl p-6 shadow-sm border border-slate-100 dark:border-slate-800">
                            <div className="flex items-center justify-between mb-6">
                                <div className="flex items-center gap-3">
                                    ...
                                    <h2 className="text-xl font-bold text-slate-900 dark:text-slate-100">Earning Rules</h2>
                                </div>
                        ...
                        <section className="bg-white dark:bg-slate-900 rounded-xl p-6 shadow-sm border border-slate-100 dark:border-slate-800">
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <h2 className="text-xl font-bold text-slate-900 dark:text-slate-100">Redemption Tiers</h2>
                            </div>
                        ...
                        <section className="bg-white dark:bg-slate-900 rounded-xl p-6 shadow-sm border border-slate-100 dark:border-slate-800">
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <h2 className="text-xl font-bold text-slate-900 dark:text-slate-100">Member Tiering</h2>
                            </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center gap-4 p-4 rounded-lg bg-slate-50 dark:bg-slate-800/50">
                                    ...
                                    <div className="flex-1">
                                        <div className="flex justify-between items-center">
                                            <span className="font-bold text-slate-900 dark:text-slate-100">Platinum Tier</span>
                    ...
                    <div className="xl:col-span-1 space-y-8">
                        <section className="sticky top-8">
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <h2 className="text-xl font-bold text-slate-900 dark:text-slate-100">Client Preview</h2>
                            </div>
                            ...
                            <div className="mt-6 p-4 rounded-xl bg-[var(--color-primary)]/10 border border-[var(--color-primary)]/20">
                                <h4 className="text-sm font-bold text-slate-900 dark:text-slate-100 mb-1">Visual Branding</h4>
                                <p className="text-xs text-slate-600 dark:text-slate-400 mb-4">Customize how your loyalty card looks to your clients.</p>
