            ...
            <div className="flex flex-col max-w-[1200px] flex-1 px-4">
                ...
                <div className="flex flex-wrap justify-between items-end gap-4 pb-8">
                    <div className="flex flex-col gap-2">
                        <h1 className="text-slate-900 dark:text-slate-100 text-4xl font-black leading-tight tracking-[-0.033em]">Business Operations Audit Log</h1>
                    ...
                    <div className="flex gap-3">
                        <button className="flex items-center justify-center rounded-lg h-11 px-5 bg-white dark:bg-slate-800 border border-[var(--color-primary)]/20 text-slate-900 dark:text-slate-100 text-sm font-bold hover:shadow-sm transition-all">
                ...
                <div className="flex gap-4 p-4 mb-6 rounded-xl bg-[var(--color-primary)]/5 border border-[var(--color-primary)]/10 flex-wrap items-center">
                    <div className="flex flex-col gap-1.5 min-w-[180px]">
                        ...
                        <button className="flex h-10 w-full items-center justify-between rounded-lg bg-white dark:bg-slate-800 border border-[var(--color-primary)]/20 px-4">
                            <span className="text-slate-900 dark:text-slate-100 text-sm font-medium">All Sensitive Actions</span>
                    ...
                    <div className="flex flex-col gap-1.5 min-w-[180px]">
                        ...
                        <button className="flex h-10 w-full items-center justify-between rounded-lg bg-white dark:bg-slate-800 border border-[var(--color-primary)]/20 px-4">
                            <span className="text-slate-900 dark:text-slate-100 text-sm font-medium">All Personnel</span>
                            <span className="material-symbols-outlined text-[var(--color-primary)] text-lg">keyboard_arrow_down</span>
                        </button>
                    </div>
                    <div className="flex flex-col gap-1.5 min-w-[180px]">
                        ...
                        <button className="flex h-10 w-full items-center justify-between rounded-lg bg-white dark:bg-slate-800 border border-[var(--color-primary)]/20 px-4">
                            <span className="text-slate-900 dark:text-slate-100 text-sm font-medium">Last 30 Days</span>
                ...
                <div className="overflow-x-auto">
                    <div className="overflow-hidden rounded-xl border border-[var(--color-primary)]/10 bg-white dark:bg-slate-900 shadow-sm min-w-[800px]">
                        <table className="w-full text-left border-collapse">
                            ...
                            <tbody className="divide-y divide-[var(--color-primary)]/5">
                                ...
                                <tr className="hover:bg-[var(--color-primary)]/5 transition-colors">
                                    ...
                                    <td className="px-6 py-5">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <span className="text-slate-900 dark:text-slate-100 text-sm font-semibold">Alex Johnson</span>
                                        </div>
                                    </td>
                                    <td className="px-6 py-5">
                                    ...
                                    <td className="px-6 py-5 text-slate-700 dark:text-slate-300 text-sm font-medium">Premium Sauna Suite #04</td>
                                ...
                                <tr className="hover:bg-[var(--color-primary)]/5 transition-colors">
                                    ...
                                    <td className="px-6 py-5">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <span className="text-slate-900 dark:text-slate-100 text-sm font-semibold">Sarah Miller</span>
                                        </div>
                                    </td>
                                    <td className="px-6 py-5">
                                    ...
                                    <td className="px-6 py-5 text-slate-700 dark:text-slate-300 text-sm font-medium">Swedish Massage (60m)</td>
                                ...
                                <tr className="hover:bg-[var(--color-primary)]/5 transition-colors">
                                    ...
                                    <td className="px-6 py-5 text-slate-700 dark:text-slate-300 text-sm font-medium">Maria Garcia</td>
                                ...
                                <tr className="hover:bg-[var(--color-primary)]/5 transition-colors">
                                    ...
                                    <td className="px-6 py-5">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <span className="text-slate-900 dark:text-slate-100 text-sm font-semibold">Kevin Lee</span>
                                        </div>
                                    </td>
                                    <td className="px-6 py-5">
                                        <span className="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-300">
                                    ...
                                    <td className="px-6 py-5 text-slate-700 dark:text-slate-300 text-sm font-medium">Deep Tissue Session ID: #882</td>
                                ...
                                <tr className="hover:bg-[var(--color-primary)]/5 transition-colors">
                                    ...
                                    <td className="px-6 py-5 text-slate-700 dark:text-slate-300 text-sm font-medium">Aromatherapy Add-on</td>
                ...
                {/* Pagination */}
                <div className="flex items-center flex-wrap gap-4 justify-between p-6 bg-white dark:bg-slate-900 mt-4 rounded-xl border border-[var(--color-primary)]/10">
                    <p className="text-sm text-slate-500 dark:text-slate-400">Showing <span className="font-bold text-slate-900 dark:text-slate-100">1</span> to <span className="font-bold text-slate-900 dark:text-slate-100">5</span> of <span className="font-bold text-slate-900 dark:text-slate-100">142</span> results</p>
                    <div className="flex items-center gap-1">
                        ...
                        <button className="flex size-10 items-center justify-center rounded-lg border border-[var(--color-primary)]/10 text-slate-600 dark:text-slate-400 hover:bg-[var(--color-primary)]/10 transition-colors text-sm font-medium">2</button>
                        <button className="flex size-10 items-center justify-center rounded-lg border border-[var(--color-primary)]/10 text-slate-600 dark:text-slate-400 hover:bg-[var(--color-primary)]/10 transition-colors text-sm font-medium">3</button>
                        <span className="mx-2 text-slate-400">...</span>
                        <button className="flex size-10 items-center justify-center rounded-lg border border-[var(--color-primary)]/10 text-slate-600 dark:text-slate-400 hover:bg-[var(--color-primary)]/10 transition-colors text-sm font-medium">28</button>
                        <button className="flex size-10 items-center justify-center rounded-lg border border-[var(--color-primary)]/20 text-slate-400 hover:text-[var(--color-primary)] transition-colors">
