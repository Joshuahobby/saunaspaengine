  ...
  return (
    <PublicLayout>
              ...
              <div className="flex flex-col gap-6">
                ...
                <ScrollReveal direction="up" delay={0.3} duration={1}>
                  <p className="text-[var(--text-muted)] text-xl md:text-2xl font-medium leading-relaxed max-w-[580px]">
                    QR check-ins, Mobile Money payments, and real-time revenue tracking — built for Rwanda&apos;s sauna and spa operators.
                  </p>
                </ScrollReveal>
              </div>
        ...
        <section className="py-24 px-6 border-t border-[var(--border-main)]">
          <ScrollReveal direction="up" className="max-w-5xl mx-auto bg-[#15241f] rounded-[var(--r-md)] p-8 md:p-16 relative overflow-hidden shadow-2xl">
