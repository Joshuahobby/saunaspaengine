    ...
    <PublicLayout>
      ...
      <main className="max-w-3xl mx-auto px-6 py-16 md:py-24">
        <div className="flex flex-col gap-4 mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-black font-display">Terms of Service</h1>
        ...
        <article className="prose-legal flex flex-col gap-10 text-[var(--text-muted)] text-[15px] leading-relaxed">
          <section>
            <h2 className="text-[var(--text-main)] text-xl font-bold font-display mb-3">1. Acceptance of Terms</h2>
          ...
          <section>
            <h2 className="text-[var(--text-main)] text-xl font-bold font-display mb-3">2. Description of Service</h2>
          ...
          <section>
            <h2 className="text-[var(--text-main)] text-xl font-bold font-display mb-3">3. User Accounts</h2>
          ...
          <section>
            <h2 className="text-[var(--text-main)] text-xl font-bold font-display mb-3">4. Acceptable Use</h2>
          ...
          <section>
            <h2 className="text-[var(--text-main)] text-xl font-bold font-display mb-3">5. Payment Terms</h2>
          ...
          <section>
            <h2 className="text-[var(--text-main)] text-xl font-bold font-display mb-3">6. Intellectual Property</h2>
          ...
          <section>
            <h2 className="text-[var(--text-main)] text-xl font-bold font-display mb-3">7. Limitation of Liability</h2>
          ...
          <section>
            <h2 className="text-[var(--text-main)] text-xl font-bold font-display mb-3">8. Termination</h2>
          ...
          <section>
            <h2 className="text-[var(--text-main)] text-xl font-bold font-display mb-3">9. Governing Law</h2>
          ...
          <section>
            <h2 className="text-[var(--text-main)] text-xl font-bold font-display mb-3">10. Contact</h2>
