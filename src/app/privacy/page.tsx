    ...
    <PublicLayout>
      ...
      <main className="max-w-3xl mx-auto px-6 py-16 md:py-24">
        <div className="flex flex-col gap-4 mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-black font-display">Privacy Policy</h1>
        ...
        <article className="prose-legal flex flex-col gap-10 text-[var(--text-muted)] text-[15px] leading-relaxed">
          <section>
            <h2 className="text-[var(--text-main)] text-xl font-bold font-display mb-3">1. Information We Collect</h2>
          ...
          <section>
            <h2 className="text-[var(--text-main)] text-xl font-bold font-display mb-3">2. How We Use Your Information</h2>
          ...
          <section>
            <h2 className="text-[var(--text-main)] text-xl font-bold font-display mb-3">3. Data Security</h2>
          ...
          <section>
            <h2 className="text-[var(--text-main)] text-xl font-bold font-display mb-3">4. Data Sharing</h2>
          ...
          <section>
            <h2 className="text-[var(--text-main)] text-xl font-bold font-display mb-3">5. Cookies &amp; Tracking</h2>
          ...
          <section>
            <h2 className="text-[var(--text-main)] text-xl font-bold font-display mb-3">6. Your Rights</h2>
          ...
          <section>
            <h2 className="text-[var(--text-main)] text-xl font-bold font-display mb-3">7. Data Retention</h2>
          ...
          <section>
            <h2 className="text-[var(--text-main)] text-xl font-bold font-display mb-3">8. Contact Us</h2>
