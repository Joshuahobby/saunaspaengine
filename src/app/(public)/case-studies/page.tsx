    ...
    return (
        <main className="flex-1">
            ...
            <article className="max-w-3xl mx-auto px-6 mb-16 prose-like">
                ...
                <blockquote className="p-6 bg-[var(--color-primary)]/10 rounded-2xl border border-[var(--color-primary)]/20 mb-8"><p className="text-lg italic font-medium mb-3">&quot;Sauna SPA Engine didn't just digitize our operations — it transformed our entire branch model. We went from surviving to thriving.&quot;</p><p className="text-sm text-[var(--color-primary)] font-bold">— Maria Korhonen, CEO, AquaLux Spa</p></blockquote>
            </article>
