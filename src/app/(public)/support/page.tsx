...
export default function SupportPage() {
    ...
    return (
        <div className="min-h-screen bg-[var(--bg-app)] text-[var(--text-main)]">
            {/* Nav */}
            <header className="flex items-center justify-between whitespace-nowrap border-b border-[var(--border-muted)] px-6 lg:px-20 py-3 bg-[var(--bg-card)]">
                ...
                <div className="flex items-center gap-4">
                    <nav className="hidden md:flex items-center gap-8">
                        <Link href="/" className="text-sm font-medium hover:text-[var(--color-primary)] transition-colors text-[var(--text-muted)]">Home</Link>
                        <Link href="/pricing" className="text-sm font-medium hover:text-[var(--color-primary)] transition-colors text-[var(--text-muted)]">Pricing</Link>
                        <Link href="/developer" className="text-sm font-medium hover:text-[var(--color-primary)] transition-colors text-[var(--text-muted)]">Developers</Link>
                    </nav>
                    <Link href="/login" className="px-4 py-2 rounded-lg bg-[var(--color-primary)] text-white text-sm font-bold hover:opacity-90 transition-all">Sign In</Link>
                </div>
            </header>
            ...
            {/* Footer */}
            <footer className="bg-[var(--bg-card)] border-t border-[var(--border-muted)] py-12 px-6 lg:px-20 mt-12">
